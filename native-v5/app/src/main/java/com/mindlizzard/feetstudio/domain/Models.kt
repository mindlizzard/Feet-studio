...
enum class SceneType(val label: String, val vehicle: Boolean = false) {
    STUDIO("Studio"), BEDROOM("Bedroom"), LIVING_ROOM("Living room"), BATHROOM("Bathroom"),
    LUXURY_HOTEL("Luxury hotel"), URBAN("Urban"), BEACH("Beach"), NATURE("Nature"),
    OFFICE("Office"), SPORTS_CAR("Sports car", true), VINTAGE_CAR("Vintage car", true)
}
